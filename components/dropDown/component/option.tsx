...
const SelectOption = ({
  ...
  return (
    <div
      ...
      className="flex py-2 text-sm flex-row-reverse items-center justify-end gap-2 hover:bg-orange-primary mb-1 px-3  hover:text-white rounded-md cursor-pointer"
    >
      {checkBox ? (
        <>
